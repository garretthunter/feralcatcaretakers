...
define('_BLOCKLOADFAILED','Block load failed');
define('_BLOCKLOWER','Block moved down');
define('_BLOCKS','Blocks');
define('_BLOCKSCONFIG','Enable collapseable menu icons?');
...
define('_BLOCKSREFRESH','Refresh time for block (only used for blocks that pull information from outside sources)');
