...
define('_FAQADDNOAUTH','You are not authorized to ask a FAQ question');
define('_FAQADMIN','FAQ Administration');
define('_FAQDELWARNING','Warning, do you want to delete this category?');
define('_NEWTOPCATEGORY','New top category');
define('_PARENTC','Parent Category');
define('_PLEASEDESCRIBE','Please describe your question:');
define('_QUESTION','Question');
define('_QUESTIONBLANK','Question cannot be blank.');
define('_QUESTIONDEL','Are you sure you want to delete this question?');
define('_QUESTIONS','Questions');
define('_SPECIFYEMAIL','Please Specify Your Email Address');
define('_SPECIFYQUESTION','Please Specify Your Question Category');
