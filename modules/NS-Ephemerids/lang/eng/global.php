...
define('_EPHEMADDNOAUTH','Not authorised to add this ephemerid');
define('_EPHEMADMIN','Ephemerids Administration');
define('_EPHEMDELETENOAUTH','Not authorised to delete this ephemerid');
define('_EPHEMDESC','Ephemerid description');
define('_EPHEMEDIT','Edit ephemerids');
define('_EPHEMEDITNOAUTH','Not authorised to edit ephemerids');
define('_EPHEMMAINT','Ephemerid maintenance (Edit/Delete):');
define('_EPHEMNOAUTH','Not authorised to access ephemerids');
?>